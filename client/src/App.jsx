    ...
    <main className="auth-shell">
      <section className="auth-art">
        ...
        <div className="auth-copy">
          ...
          <p>
            Your files are encrypted before they leave your device, so your work
            stays yours.
          </p>
...
function Dashboard({ user, onLogout }) {
  ...
  const active =
    appRoutes.find((item) => item.path === location.pathname)?.name ||
    "Overview";
  ...
  const usedPercent = Math.min(
    100,
    Math.round((used / (10 * 1024 * 1024 * 1024)) * 100),
  );
  const nav = appRoutes;
  return (
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-foot">
          <span>Need help?</span>
          <a
            href="https://github.com/srikesav09/SecureShare"
            target="_blank"
            rel="noreferrer"
          >
          ...
          {active !== "Overview" ? (
            <div className="empty-section">
              <div className="empty-icon">
                <Icon
                  name={
                    nav.find((item) => item.name === active)?.icon || "grid"
                  }
                  size={28}
                />
              </div>
              <h2>{active}</h2>
              <p>
                This workspace is ready for the next step. Your core file
                workflow is available from Overview.
              </p>
              <button
            ...
            <>
              <div className="stats-row">
                <div className="stat-card">
                  ...
                  <em>
                    {files.length ? "Up to date" : "Start with your first file"}
                  </em>
                </div>
                <div className="stat-card">
              ...
              >
                ...
                <span>
                  ...
                  <small>
                    Encrypted before it leaves your device · Max 50 MB
                  </small>
                </span>
              ...
              <div className="dashboard-grid">
                ...
                <aside className="panel health-panel">
                  ...
                  <div className="meter">
                    <span
                      style={{ width: `${Math.max(8, 100 - usedPercent)}%` }}
                    />
                  </div>
                  ...
                  <div className="share-callout">
                    ...
                    <p>
                      Create links that expire automatically and can be revoked
                      anytime.
                    </p>
                  </div>
                </aside>
